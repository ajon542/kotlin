...
import downundergames.kotlin.BreadthFirstTraversalStrategy
import downundergames.kotlin.Node

class BreadthFirstTraversalTests {
    @Test
    fun testSingleNodeBreadthFirst() {
        ...
        var traversalStrategy = BreadthFirstTraversalStrategy(visitor)
    ...
    @Test
    fun testSingleChildNodeBreadthFirst() {
        var node = Node().apply {
            id = 0
    ...
    @Test
    fun testMultipleChildNodesBreadthFirst() {
        var node = Node().apply {
            id = 0
        ...
        assertEquals(3, list[3].id)
    }

    @Test
    fun testFullNodeTreeBreadthFirst() {
        ...
        assertEquals(2, list[2].id)
        assertEquals(3, list[3].id)
        assertEquals(4, list[4].id)
        assertEquals(5, list[5].id)
        assertEquals(6, list[6].id)
        assertEquals(7, list[7].id)
        assertEquals(8, list[8].id)
        assertEquals(9, list[9].id)
        assertEquals(10, list[10].id)
        assertEquals(11, list[11].id)
        assertEquals(12, list[12].id)
    }
}